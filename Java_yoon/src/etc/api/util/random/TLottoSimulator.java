...
public class TLottoSimulator {
	...
	//당첨 등수를 알려주는 메서드
	public static void checkLottoNumber(Set<Integer> myLotto, Set<Integer> win, int bonus) {
		/*
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(prize1 == 1) {
				...
				System.out.println("-------------------------");
				System.out.println("1등 한번 되려고 당신이 쓴 금액: " + (paper*1000L));
				break;
			} else {
