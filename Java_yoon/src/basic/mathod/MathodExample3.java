package basic.mathod;import java.util.Arrays;

/*
# 반환값, 반한 유형 (return value, return type)

1. 반환값이란 메서드의 실행 결과값을 의미합니다.

2. 메개변수는 여러 개 존재할 수 있지만, 반환되는 값은 오직 한 개만
 존재해야 합니다.
...
//		System.out.println("야"); (x)
	...
	static int[] operatTotal(int n1, int n2){
...
//			continue;			
	...
	public static void main(String[] args) {
		...
		int[] totalResult = operatTotal(30, add(2,4));
		...
		System.out.println(Arrays.toString(operatTotal(30,6)));
		...
		System.out.printf("평균: %.2f", result[1]);
